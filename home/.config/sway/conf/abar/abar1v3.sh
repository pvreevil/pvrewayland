...
while
	...
	printf %s	",[
			...
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"dw\"},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$(cat $BARPATH/netspeed/speed | awk '{print $1 $2}')\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"up\"},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$(cat $BARPATH/netspeed/speed | awk '{print $3 $4}')\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"<span font_desc='mononoki Nerd Font Mono 20'></span>\",$mu},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$GH\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"<span font_desc='mononoki Nerd Font Mono 20'>樓</span>\",$mu},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$RDD\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"<span font_desc='mononoki Nerd Font Mono 15'></span>\",$mu},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$RSS\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"<span font_desc='mononoki Nerd Font Mono 14'>$VOLI</span>\",$mu},
			{$c \"$clraf\",$b \"$clra2\",$s,$sw 3,$ac,$mw 42,$ft \"$VOL\"},
			{$c \"$clraf\",$b \"$clra1\",$s,$sw 0,$ac,$mw 24,$ft \"<span font_desc='mononoki Nerd Font Mono 18'></span>\",$mu},
